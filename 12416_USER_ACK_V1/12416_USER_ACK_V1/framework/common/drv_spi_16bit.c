...
// error checks
#if !defined( DRV_SPI_CONFIG_CHANNEL_1_ENABLE ) && !defined( DRV_SPI_CONFIG_CHANNEL_2_ENABLE ) &&                      \
    !defined( DRV_SPI_CONFIG_CHANNEL_3_ENABLE ) && !defined( DRV_SPI_CONFIG_CHANNEL_4_ENABLE )
...
#pragma message                                                                                                        \
    "DRV_SPI_CONFIG_ENHANCED_BUFFER_DISABLE is automatically enabled because SPI FIFO mode is not supported on this device."
#endif
#endif
 ...
 *****************************************************************************/
void DRV_SPI_Initialize( const DRV_SPI_INIT_DATA *pData )
{
