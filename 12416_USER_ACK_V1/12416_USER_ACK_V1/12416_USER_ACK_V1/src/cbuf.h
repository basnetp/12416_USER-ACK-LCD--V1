/**
*   A simple and efficient set of circular buffer manipulations.
*
...
*   @endcode
*
 * @see https://github.com/dhylands/TimerUART/blob/master/CBUF.h
****************************************************************************/
 ...
 *  NOTE assumption of uint16 data type
*/

#define CBUF_Len( cbuf ) ( ( uint16_t )( ( cbuf.m_putIdx ) - ( cbuf.m_getIdx ) ) )
...
/**
 * empty the buffer and discard contents
 */
#define CBUF_Flush( cbuf ) ( cbuf.m_getIdx = cbuf.m_putIdx )
...
template <class IndexType, unsigned Size, class EntryType> class CBUF
{
  public:
    CBUF()
    {
